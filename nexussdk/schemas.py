...
class Schemas:
    ...
    def fetch(self, org_label, project_label, schema_id, rev=None, tag=None):
        """
    ...
    def create(self, org_label, project_label, schema_obj, schema_id=None):
        ...
        if schema_id is None:
            return self._http.post(path, schema_obj, use_base=True)
        else:
            schema_id = url_encode(schema_id)
            path = path + "/" + schema_id
            return self._http.put(path, schema_obj, use_base=True)

    def update(self, schema, rev=None):
        """
        ...
        return self._http.put(path, schema, use_base=False)

    def deprecate(self, schema, rev=None):
        """
    ...
    def tag(self, schema, tag_value, rev_to_tag=None, rev=None):
        """
