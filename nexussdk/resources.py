...
class Resources:
    ...
    def fetch(self, org_label, project_label, resource_id, schema_id="_", rev=None, tag=None, source=None):
        """
            ...
            :param source: OPTIONAL fetches the resource source, ie: the original payload (default: None)
