...
class Views:
    _elastic_type = "ElasticSearchView"
    _sparql_type = "SparqlView"

    def __init__(self, http: Http):
        self._http = http

    def create_(self, org_label: str, project_label: str, payload: Dict, view_id: Optional[str]):
        ...
        return self._http.post(path, body=payload, use_base=True)

    def create_es(self, org_label: str, project_label: str, mapping: Dict, view_id: Optional[str] = None,
        ...
        return self.create_(org_label, project_label, payload, view_id)

    def update_es(self, esview, rev=None):
        """
        ...
        return self._http.put(path, esview, use_base=False)

    def deprecate_es(self, esview, rev=None):
        """
        Update a ElasticSearch view. The esview object is most likely the returned value of a
        nexus.views.fetch(), where some fields where modified, added or removed.
        Note that the returned payload only contains the Nexus metadata and not the
        ...
        return self._http.delete(path, esview, use_base=False)

    def fetch(self, org_label, project_label, view_id, rev=None, tag=None):
        """
    ...
    def tag_es(self, esview, tag_value, rev_to_tag=None, rev=None):
        """
        ...
        return self._http.put(path, body=data, use_base=False)

    def create_es_aggregated(self, org_label: str, project_label: str, es_views: List[Dict],
    ...
    def list_keep_only_es(self, viewlist):
        """
    ...
    def query_es(self, org_label: str, project_label: str, query: Union[str, Dict],
        ...
        return self._http.post(path, body=query, use_base=True)

    def create_sparql(self, org_label: str, project_label: str, view_id: Optional[str] = None,
                      resource_schemas: Optional[Set[str]] = None,
                      resource_types: Optional[Set[str]] = None,
                      tag: Optional[str] = None,
    ...
    def create_sparql_aggregated(self, org_label: str, project_label: str, sparql_views: [Set[Dict]],
                                 view_id: Optional[str]) -> Dict:
    ...
    def query_sparql(self, org_label: str, project_label: str, query: str,
        ...
        return self._http.post(path, body=query, data_type="sparql", use_base=True)

    def stats(self, org_label: str, project_label: str, view_id: str) -> Dict:
        """
        ...
        """
        return self._http.get(["views", org_label, project_label, url_encode(view_id), "statistics"])
